    ...
    <main>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <ol class="carousel-indicators">
                ...
                <li data-target="#carousel-example-generic" data-slide-to="3A"></li>
            </ol>

            <!-- Wrapper for slides -->
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <a href="#"><img src="img/destaque-seja-bem-vindo.png" alt="Seja Bem-vindo"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="img/destaque-revolveres.png" alt="Revólveres"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="img/destaque-municoes.png" alt="Munições"></a>
                </div>
                <div class="item">
                    <a href="#"><img src="img/destaque-como-comprar.png" alt="Comprar"></a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Ftaurusarmasofficial%2F&tabs&width=480&height=214&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=298450296104" width="480" height="214" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                    <div class="social-networks">
                        <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <form action="#">
                            ...
                            <div class="form-group">
                                <label for="inputName" class="sr-only">Assunto</label>
                                <input type="email" class="form-control" id="inputSubject" placeholder="Assunto">
                            </div>
